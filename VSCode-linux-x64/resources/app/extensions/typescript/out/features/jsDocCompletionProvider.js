...
class JsDocCompletionProvider {
    ...
    provideCompletionItems(document, position, _token) {
        ...
        if (prefix.match(/^\s*$|\/\*\*\s*$|^\s*\/\*\*+\s*$/)) {
            const enableJsDocCompletions = vscode_1.workspace.getConfiguration(configurationNamespace).get(Configuration.enabled, true);
...
//# sourceMappingURL=https://ticino.blob.core.windows.net/sourcemaps/929bacba01ef658b873545e26034d1a8067445e9/extensions/typescript/out/features/jsDocCompletionProvider.js.map

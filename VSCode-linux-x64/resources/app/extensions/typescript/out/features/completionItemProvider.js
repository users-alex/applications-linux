...
class TypeScriptCompletionItemProvider {
    constructor(client, mode, typingsStatus) {
        this.client = client;
        this.typingsStatus = typingsStatus;
        this.commandId = `_typescript.applyCompletionCodeAction.${mode}`;
        vscode_1.commands.registerCommand(this.commandId, this.applyCompletionCodeAction, this);
    }
    ...
    resolveCompletionItem(item, token) {
        ...
        return this.client.execute('completionEntryDetails', args, token).then((response) => {
            ...
            if (item.source) {
                ...
                documentation.appendMarkdown(localize(2, null, importPath));
    ...
    applyCompletionCodeAction(file, codeActions) {
        return __awaiter(this, void 0, void 0, function* () {
...
//# sourceMappingURL=https://ticino.blob.core.windows.net/sourcemaps/929bacba01ef658b873545e26034d1a8067445e9/extensions/typescript/out/features/completionItemProvider.js.map

...
var MarkdownEngine = /** @class */ (function () {
    ...
    MarkdownEngine.prototype.getEngine = function (resource) {
            ...
            return __generator(this, function (_e) {
                switch (_e.label) {
                    ...
                    case 3:
                        ...
                        _e.label = 4;
                    case 4:
                        config = vscode.workspace.getConfiguration('markdown', resource);
                        this.md.set({
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.getEngine(document)];
                    case 1:
                        engine = _a.sent();
...
//# sourceMappingURL=https://ticino.blob.core.windows.net/sourcemaps/929bacba01ef658b873545e26034d1a8067445e9/extensions/markdown/out/markdownEngine.js.map
